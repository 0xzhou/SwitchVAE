...
def cnn_img(input_shape):
    ...
    conv1 = Conv2D(filters=96, kernel_size=(7, 7), strides=(3, 3),
                   ...
                   kernel_initializer='glorot_normal', name='conv1')(inputs)
    ...
    conv2 = Conv2D(256, (5, 5), padding='same', activation='relu',
                   kernel_initializer='glorot_normal', name='conv2')(pool1)
    pool2 = MaxPool2D((2, 2), (2, 2), name='pool2')(conv2)

    conv3 = Conv2D(384, (3, 3), padding='same', activation='relu',
                   kernel_initializer='glorot_normal', name='conv3')(pool2)
    ...
    conv5 = Conv2D(256, (3, 3), padding='same', activation='relu',
                   kernel_initializer='glorot_normal', name='conv5')(conv4)
...
def get_img_encoder(z_dim = 200):
    ...
    inputs = Input(shape=g.VIEWS_IMAGE_SHAPE, name='input')
    ...
    fc6 = Dense(units=4096, activation='relu', kernel_regularizer=g.l2_reg, name='fc6')(pool5_vp)
    ...
    fc7 = Dense(4096, 'relu', kernel_regularizer=g.l2_reg, name='fc7')(dropout6)
    dropout7 = Dropout(0.6, name='dropout7')(fc7)
    fc8 = Dense(343, kernel_regularizer=g.l2_reg, name='fc8')(dropout7)
